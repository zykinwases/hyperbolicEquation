...
OmpMpiSolver::OmpMpiSolver(double l[3], int dots) {
    Lx = l[0];
    Ly = l[1];
    Lz = l[2];
...
double OmpMpiSolver::laplasian(double *u_n, int i, int j, int k) {
...
void OmpMpiSolver::fill_borders(double *u_t, int t) {
    // periodic x
...
void OmpMpiSolver::fill_interface(double *u) {
...
double OmpMpiSolver::find_error(double *u_t, int t) {
...
double OmpMpiSolver::solve(int steps) {

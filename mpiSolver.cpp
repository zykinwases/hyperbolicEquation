...
MpiSolver::MpiSolver(double l[3], int dots) {
    Lx = l[0];
    Ly = l[1];
    Lz = l[2];
...
double MpiSolver::laplasian(double *u_n, int i, int j, int k) {
...
void MpiSolver::fill_borders(double *u_t, int t) {
    // periodic x
...
void MpiSolver::fill_interface(double *u) {
...
double MpiSolver::find_error(double *u_t, int t) {
...
double MpiSolver::solve(int steps) {
